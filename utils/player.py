"""
Класс `Player` представляет собой игрока в игре. Он предоставляет методы для управления данными игрока, включая имя, деньги, состав, город, пол и цвет кожи. Класс также предоставляет методы для кэширования и сохранения данных игрока в базу данных MongoDB и хранилище Redis.

Функция `init_player_by_db` используется для инициализации экземпляра `Player` из данных игрока, хранящихся в базе данных MongoDB.

Функция `get_player` возвращает текущий экземпляр `Player`, если он был инициализирован.
"""
